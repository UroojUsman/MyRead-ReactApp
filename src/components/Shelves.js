    ...
    render(){
      ...
      const read= allBooks.filter(book=> book.shelf ==='read');
        ...
        return(
            ...
            <div>
              <Shelf books={currentlyReading} title='Currently Reading'onShelfChange={this.props.shelfChanger}/>
              <Shelf books={wantToRead} title='Want to Read' onShelfChange={this.props.shelfChanger}/>
              <Shelf books={read} title='Read'onShelfChange={this.props.shelfChanger}/>
